# PRD — Kasir & Harga Layanan

**Epic:** PTS-602 — `[CRM][Bidan] Kasir & Harga Layanan` · **Task PRD:** PTS-614
...
**Kode referensi:** O3-05 · Level S2 · Platform: Web (CRM Bidan)
...
- Prototype acuan: `docs/prototype/CRMBidan_15sep2026.html`
- Naskah ringkasan pemeriksaan & invoice: `docs/copy-deck-wa-ringkasan-invoice.md` + `.pdf`
- Keputusan produk & hasil grill: `features/crm-bidan/context/CONTEXT.md`
- PRD terkait: PTS-382 (Kantong Persalinan) · PTS-386 (Pengingat Kunjungan) · PTS-370 (Login & Manajemen Data Pasien)
